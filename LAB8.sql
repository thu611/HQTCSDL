...
EXEC sp_THEMNHANVIEN 'NV04',N'Diệp Hoàng Thư',N'Nữ',N'Tiền Giang','0983416755','ht0611@gmail.com',N'Vật tư',0
--Câu 2--
...
EXEC ThemMoiSanPham 'SP06',N'Điện thoại Oppo','Oppo F9','20','Xanh','6500000',N'Chiếc',N'Hàng cao cấp',0
--Câu 3--
...
BEGIN
    ...
    -- Thực hiện xoá sản phẩm khỏi bản Sanpham
    DELETE FROM sanpham WHERE masp = @masp;
    
    -- Thực hiện xoá các bản ghi trong bảng Nhap và Xuat mà sản phẩm này tham gia
...
EXEC XoaSanPham 'SP001', @errorCode OUTPUT;
SELECT @errorCode;
--Câu 5--
